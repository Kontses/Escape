...
const home = {
  ...
  subline: (
    <>
      Οι Aztek είναι μια μουσική κολεκτίβα που δημιουργήθηκε για να αφυπνίσει συνειδήσεις και να κουνίσει κώλους (μεταφορικά και κυριολεκτικά).
...
const about = {
  ...
  customSections: [
    ...
    },
    {
      ...
      description: (
        <>
          "Δεν έχουμε τίποτα δικό μας, παρά μόνο τον χρόνο, τον οποίο μπορούν να απολαύσουν και όσοι δεν έχουν που την κεφαλήν κλίνει." - Μπαλτάσαρ Γκρασιάν
        </>
      ),
    },
  ],
