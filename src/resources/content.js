...
export const about = {
  ...
  customSections: [
    ...
    },
    {
      title: "Κατακλείδα",
      description: (
        <p><em>&quot;Δεν έχουμε τίποτα δικό μας, παρά μόνο τον χρόνο, τον οποίο μπορούν να απολαύσουν και όσοι δεν έχουν που την κεφαλήν κλίνει.&quot;</em> - Μπαλτάσαρ Γκραθιάν</p>
      ),
    },
  ],
};
...
export const gallery = {
  ...
  images: [
    ...
    {
      src: "/images/gallery/Olumpos-Hysteria-2.jpg",
      alt: "Olumpos Hysteria vol. 2",
      orientation: "vertical",
    }
  ],
};