...
<CodeBlock
    ...
    <Row fillWidth horizontal="center">
      <Card
        ...
        gap="8"
      >
        <Media src="/images/projects/Live-Sets/cover-01.jpg" aspectRatio="16/9" radius="l" sizes="400px" />
...
<CodeBlock
    ...
    topRadius="l"
    codeHeight={24}
    preview={<Media src="/images/projects/Live-Sets/cover-01.jpg" alt="Example image" sizes="640px" aspectRatio="16/9" radius="l" />}
    codes={[
      {
        code:
`<Media
